...
# Find end index (which is right before "5.2 Análise Aprofundada dos Resultados")
end_idx = -1
...
if start_idx != -1 and end_idx != -1:
    # Ensure there's a blank line before 5.2
    new_lines = lines[:start_idx] + [new_content + "\n\n"] + lines[end_idx:]
    with open(file_path, "w", encoding="utf-8") as f:
        f.writelines(new_lines)
    print("Texto atualizado com sucesso devolvendo os exemplos!")
else:
